{
    ...
    fields: [
      ## Keeping this field in order to allow future authentication methods in the future
      {
        ...
        hint: 'This can be found in the URL of your NetSuite account.
          Your production account ID will be 7-digits (eg. 1234567), your sandbox ID will include a hyphen and the sandbox number (eg. 1234567-sb1)',
        optional: false
      },
      {
        name: 'certificate_id',
        label: 'Certificate ID',
        hint: 'This is the ID generated by NetSuite after you upload the certificate file to the OAuth 2.0 Client Credentials Setup page. This is found under Setup > Integration > OAuth 2.0 Client Credentials (M2M) Setup within NetSuite.',
        optional: false,
        control_type: :text
      },
      {
      ...
      },
      {
        name: 'private_key',
        label: 'Private Key',
        hint: "This is the contents of the private key file used to sign the certificate that was uploaded to NetSuite's 'OAuth 2.0 Client Credentials Setup page'",
        optional: false,
        control_type: 'password',
        multiline: true
      }
  ...
  actions: {
    ...
    "get_process_status": {
      ...
      summarize_output: ['results', 'errors'],
      ...
      config_fields: [
        {
          ...
          hint: 'Select a pre-configured ZAB API Export record that corresponds to a saved search of records within your NetSuite account.',
          ...
          toggle_field: {
            name: 'export_id',
            label: 'ZAB API Export',
            hint: 'Indicate the specific ZAB API Export ID configured in your environment that you would like to retrieve.',
            control_type: :string,
            extends_schema: true,
            change_on_blur: true,
            type: :string,
    ...
    "get_record": {
      ...
      execute: lambda do |connection, input|
        ...
        if (results.length == 0)
          identifier = input['internal_id'] ? "Internal ID: #{input['internal_id']}" : "External ID: #{input['external_id']}"
  ...
  custom_action_help: {
    ...
    body: '<p>Build your own ZoneBilling action with a HTTP request. <b>The request will be authorized with your ZoneBilling NetSuite connection.</b></p>'
  },
  ...
  pick_lists: {
      ...
      response['results'].each do |objResult|
        results.push(
          [
            ...
            # API Name
            objResult['custrecordzab_apixport_export_id']['value']
          ]
        )
      end
    ...
    file_compression_type: lambda do |connection|
      [
        ['CPIO', 'cpio'],
        ['TAR', 'tar'],
        ['TBZ2', 'tbz2'],
    ...
    file_export_type: lambda do |connection|
      [
        ['PDF', 'recordpdf'],
        ['HTML', 'recordhtml']
      ]
    ...
    filter_types: lambda do |connection|
      [
        ['Default', 'filter'],
        ['Date', 'filterdate'],
    ...
    operators: lambda do |connection|
      [
        ["After", "after"],
        ["All of", "allof"],
        ["Any", "any"],
  ...
  object_definitions: {
        ...
        [
          {
            name: 'export_id',
            label: 'ZAB API Export',
            hint: "Customize your request's response by providing a related ZAB API Export. This will return an additional 'results' property that will contain the export's results, filtered to your specific record. ",
            pick_list: 'api_exports',
            control_type: :select,
            extends_schema: true,
            optional: true,
        ...
        [
          {
            ...
            hint: "External References allow you to identify the value of a select field by an attribute field on it's corredponding record type.
              (Eg., configure an external reference so the 'customer' field can be identified by the external ID field of the customer, rather than the internal ID)",
            type: :array,
            of: :object,
            list_mode: 'static',
        ...
        [
          {
            name: 'field_id',
            label: 'Field ID',
            hint: "Select the field ID of the select field on the target record. (For Example, the 'customer' field on the 'contact'.)",
            type: :string,
            control_type: :select,
            optional: false,
            extends_schema: true,
            ...
            toggle_field: {
              ...
              extends_schema: true,
              toggle_hint: 'ID',
              hint: "Indicate the field ID of the select field on the target record. (For Example, the 'customer' field on the 'contact'.)"
            }
          },
          {
            name: 'related_field_id',
            label: 'Related Field ID',
            hint: "Select the related record type and the field ID which contains the identifying attribute. (Eg. Select 'Customer' then 'externalid', to identify the select field by the customer's externalid)",
            control_type: 'tree',
            optional: false,
            sticky: true,
            ...
            toggle_field: {
              ...
              optional: false,
              toggle_hint: 'ID',
              hint: 'Indicate the related record type and the field ID that contains the unique external reference. This should be joined together by a "." (Eg. "customer.externalid")'
            }
          }
        ]
      end
        ...
        [
          {
            name: 'record_type',
            label: 'Record Type',
            hint: "Select the record type of the target ZAB API Export which you would like to filter on. This is required in order to source the fields to filter below.",
            type: :string,
            control_type: :select,
            extends_schema: true,
            sticky: true,
            ...
            toggle_field: {
              name: 'record_type',
              label: 'Record Type',
              hint: 'Indicate the record type of the target ZAB API Export which you would like to filter on. This is required in order to source the fields to filter below',
              control_type: :string,
              change_on_blur: true,
              extends_schema: true,
              type: :string,
        ...
        [
          {
            ...
            toggle_field: {
              ...
              extends_schema: true,
              toggle_hint: 'ID',
              hint: 'Indicate the specific field you want to filter by. You can join to another record for complex filtering by adding a dot (Eg. "customer.email"). '
            }
          },
          {
            name: 'operator',
          ...
          },
          {
            name: 'type',
            label: 'Type',
            hint: "It is necessary to change this in scenarios where the filter data type is either a 'Date' or 'Date/Time' field. Default behavior is used unless otherwise indicated.",
            type: :string,
            control_type: :select,
            optional: false,
            sticky: true,
        ...
        [
          {
            ...
            label: 'Export Type',
            hint: 'Select the type of file you would like to retrieve from NetSuite, either record PDF or record HTML. By default, the record PDF is returned.',
            control_type: :select,
          ...
          },
          {
            ...
            hint: 'Select the compression type that you would like the file to be returned in. By default, the content is returned in a Base64 format.',
            control_type: :select,
          ...
          },
          {
            name: 'template_id',
            label: 'Template ID',
            hint: 'Provide a specific Template ID that you would like the record file to be formatted in. If the record type is not a transaction, this is required.',
            type: :integer,
            control_type: :integer,
            sticky: true,
        ...
        [
          {
            name: 'automations',
            label: 'Automations',
            hint: "Select the ZAB Automation you would like to trigger upon completion of your request. Select multiple ZAB Automations to chain multiple automations together.",
            ...
            toggle_field: {
              ...
              extends_schema: true,
              toggle_hint: 'ID',
              hint: 'Indicate the specific automation IDs you want to trigger upon completion of your request. For chained ZAB Automations, seperate each ID by a comma (Eg. "1,2,3,4").'
            }
          }
        ]
      end
        ...
        fields = [
          {
            ...
            properties: fields.map { |field|
              ...
              is_external_reference = !!external_references.find { |external_reference|
    ...
    post_response: {
      fields: lambda do |connection, config_fields, object_definitions|
        fields = []
        options = config_fields['options'] || {}
        record_fields = config_fields['record_fields'] || {}
  ...
  methods: {
    ...
    validate_response: lambda do |code, body, headers|
      ...
      if (!error_check['success'] || error_check['error'])
        ...
        error_title = error_details['name'].to_s || 'API_ERROR'
        error_message = error_details['message'].to_s || 'There was an error with your request. Please check the logs in Workato and NetSuite.'
    ...
    get_workato_field: lambda do |field, is_mandatory|
      ...
      is_custom = field_id.match?(/Acust/) && !field_id.match?(/zab_/) ## Only mark custom fields that start with 'cust', but not ZAB Fields
    ...
    parse_record_field_key: lambda do |key|
      ...
      isText = key_parts[1] ? key_parts[1] == 'text' : false

      new_key = isText ? key_parts[0] + '.text' : key_parts[0]
